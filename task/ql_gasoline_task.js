/*
cron "25 6 * * *" ql_gasoline_task.js, tag=汽油价格
* 汽油价格任务:脚本更新地址 task/ql_gasoline_task.js
  配置参数 input.js
*/

process.env.GASOLINE_QUIET = '1'
...
const $ = new Env('汽油价格', { startQuiet: true });
